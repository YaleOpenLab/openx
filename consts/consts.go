...
const StableCoinAddress = "GCP6L57CAXTH6C6DLBF645IJ53PGTASVVPPKFRFJNQMXUI2TJRFSIVOU" // the address of the stablecoin must be a constant for the payment listener to work properly
