...
const StableCoinAddress = "GCX4BSWDWHDDGLLTA6C73NENJCQBST7C4B4W5HZE7ZCSOVWML7VLLLT3" // the address of the stabellcoin must be a constant for the payment listener to work properly
