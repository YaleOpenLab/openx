...
const StableCoinAddress = "GBQLGMF65GXDJMWFMOPU6RO5AXZGQKDKIUYIVZY47RFHRTAZU4RMMYFU" // the address of the stablecoin must be a constant for the payment listener to work properly
