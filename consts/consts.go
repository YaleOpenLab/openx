...
const StableCoinAddress = "GAKU7L7WLRG2BWGYF7TPNIAWPUURFZJURJY4FQBH4CFBPITYEN6BNTFK" // the address of the stablecoin must be a constant for the payment listener to work properly
