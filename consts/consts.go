...
const StableCoinAddress = "GCSMRNO2NBLVULZAIAHA7PAPMFXXLFMLMEAZ23XPNGWMNSY2RL6GJYZR" // the address of the stablecoin must be a constant for the payment listener to work properly
