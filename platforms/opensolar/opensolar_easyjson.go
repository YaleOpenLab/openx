	...
	for !in.IsDelim('}') {
		...
		case "CommunityEngagement":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v15 CommunityEngagementHelper
					(v15).UnmarshalEasyJSON(in)
					out.CommunityEngagement = append(out.CommunityEngagement, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar5(out *jwriter.Writer, in Project) {
	...
	}
	{
		...
		if in.InvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v16, v17 := range in.InvestorIndices {
				if v16 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v17))
	...
	}
	{
		...
		if in.SeedInvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v18, v19 := range in.SeedInvestorIndices {
				if v18 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v19))
	...
	}
	{
		...
		if in.RecipientIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v20, v21 := range in.RecipientIndices {
				if v20 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v21))
	...
	}
	{
		...
		if in.DeveloperIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v22, v23 := range in.DeveloperIndices {
				if v22 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v23))
	...
	}
	{
		...
		if in.DeveloperFee == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v24, v25 := range in.DeveloperFee {
				if v24 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StageData == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v26, v27 := range in.StageData {
				if v26 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StageChecklist == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v28, v29 := range in.StageChecklist {
				if v28 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.InvestorMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v31First := true
			for v31Name, v31Value := range in.InvestorMap {
				if v31First {
					v31First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.WaterfallMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v32First := true
			for v32Name, v32Value := range in.WaterfallMap {
				if v32First {
					v32First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.CommunityEngagement == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v35, v36 := range in.CommunityEngagement {
				if v35 > 0 {
					out.RawByte(',')
				}
...
func easyjson4a457b9dDecodeGithubComYaleOpenLabOpenxPlatformsOpensolar8(in *jlexer.Lexer, out *ExecutiveSummaryHelper) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "SustainabilityMetrics":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					(out.SustainabilityMetrics)[key] = v40
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar8(out *jwriter.Writer, in ExecutiveSummaryHelper) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Investment == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v41First := true
			for v41Name, v41Value := range in.Investment {
				if v41First {
					v41First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Financials == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v42First := true
			for v42Name, v42Value := range in.Financials {
				if v42First {
					v42First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ProjectSize == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v43First := true
			for v43Name, v43Value := range in.ProjectSize {
				if v43First {
					v43First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.SustainabilityMetrics == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v44First := true
			for v44Name, v44Value := range in.SustainabilityMetrics {
				if v44First {
					v44First = false
				} else {
					out.RawByte(',')
...
func easyjson4a457b9dDecodeGithubComYaleOpenLabOpenxPlatformsOpensolar9(in *jlexer.Lexer, out *CommunityEngagementHelper) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar9(out *jwriter.Writer, in CommunityEngagementHelper) {
	out.RawByte('{')
	first := true
	_ = first
	{
