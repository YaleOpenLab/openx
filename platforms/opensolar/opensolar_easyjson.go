...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar5(out *jwriter.Writer, in Project) {
	...
	}
	{
		...
		if in.InvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v17, v18 := range in.InvestorIndices {
				if v17 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v18))
	...
	}
	{
		...
		if in.SeedInvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v19, v20 := range in.SeedInvestorIndices {
				if v19 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v20))
	...
	}
	{
		...
		if in.RecipientIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v21, v22 := range in.RecipientIndices {
				if v21 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v22))
	...
	}
	{
		...
		if in.DeveloperIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v23, v24 := range in.DeveloperIndices {
				if v23 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v24))
	...
	}
	{
		...
		if in.DeveloperFee == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v25, v26 := range in.DeveloperFee {
				if v25 > 0 {
					out.RawByte(',')
				}
				out.Float64(float64(v26))
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.StageData == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v27, v28 := range in.StageData {
				if v27 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StageChecklist == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v29, v30 := range in.StageChecklist {
				if v29 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.InvestorMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v32First := true
			for v32Name, v32Value := range in.InvestorMap {
				if v32First {
					v32First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ContractList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v36, v37 := range in.ContractList {
				if v36 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CommunityEngagement == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v38, v39 := range in.CommunityEngagement {
				if v38 > 0 {
					out.RawByte(',')
				}
		...
		case "SustainabilityMetrics":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					(out.SustainabilityMetrics)[key] = v43
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar10(out *jwriter.Writer, in ExecutiveSummaryHelper) {
	...
	_ = first
	{
		...
		if in.Investment == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v44First := true
			for v44Name, v44Value := range in.Investment {
				if v44First {
					v44First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Financials == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v45First := true
			for v45Name, v45Value := range in.Financials {
				if v45First {
					v45First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ProjectSize == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v46First := true
			for v46Name, v46Value := range in.ProjectSize {
				if v46First {
					v46First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.SustainabilityMetrics == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v47First := true
			for v47Name, v47Value := range in.SustainabilityMetrics {
				if v47First {
					v47First = false
				} else {
					out.RawByte(',')
