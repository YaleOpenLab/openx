	...
	for !in.IsDelim('}') {
		...
		case "PendingDocuments":
			if in.IsNull() {
				...
				in.Delim('{')
				if !in.IsDelim('}') {
					out.PendingDocuments = make(map[int]string)
				} else {
		...
		case "ContractList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ContractList = append(out.ContractList, v16)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "CommunityEngagement":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v17 CommunityEngagementHelper
					(v17).UnmarshalEasyJSON(in)
					out.CommunityEngagement = append(out.CommunityEngagement, v17)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "OImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.OImages = append(out.OImages, v18)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "OOImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.OOImages = append(out.OOImages, v19)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "AImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AImages = append(out.AImages, v20)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "EImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EImages = append(out.EImages, v21)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CEImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.CEImages = append(out.CEImages, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "PSImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.PSImages = append(out.PSImages, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "BNImages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BNImages = append(out.BNImages, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar5(out *jwriter.Writer, in Project) {
	...
	}
	{
		...
		if in.InvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v26, v27 := range in.InvestorIndices {
				if v26 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v27))
	...
	}
	{
		...
		if in.SeedInvestorIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v28, v29 := range in.SeedInvestorIndices {
				if v28 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v29))
	...
	}
	{
		...
		if in.DeveloperIndices == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v32, v33 := range in.DeveloperIndices {
				if v32 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v33))
	...
	}
	{
		...
		if in.DeveloperFee == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v34, v35 := range in.DeveloperFee {
				if v34 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StageData == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v36, v37 := range in.StageData {
				if v36 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.StageChecklist == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v38, v39 := range in.StageChecklist {
				if v38 > 0 {
					out.RawByte(',')
				}
				if v39 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v40First := true
					for v40Name, v40Value := range v39 {
						if v40First {
							v40First = false
						} else {
							out.RawByte(',')
	...
	}
	{
		...
		if in.InvestorMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v41First := true
			for v41Name, v41Value := range in.InvestorMap {
				if v41First {
					v41First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.WaterfallMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v42First := true
			for v42Name, v42Value := range in.WaterfallMap {
				if v42First {
					v42First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.PendingDocuments == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v45First := true
			for v45Name, v45Value := range in.PendingDocuments {
				if v45First {
					v45First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ContractList == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v46, v47 := range in.ContractList {
				if v46 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CommunityEngagement == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v48, v49 := range in.CommunityEngagement {
				if v48 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.FEText == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v64First := true
			for v64Name, v64Value := range in.FEText {
				if v64First {
					v64First = false
				} else {
					out.RawByte(',')
		...
		case "SustainabilityMetrics":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					(out.SustainabilityMetrics)[key] = v68
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson4a457b9dEncodeGithubComYaleOpenLabOpenxPlatformsOpensolar10(out *jwriter.Writer, in ExecutiveSummaryHelper) {
	...
	_ = first
	{
		...
		if in.Investment == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v69First := true
			for v69Name, v69Value := range in.Investment {
				if v69First {
					v69First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Financials == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v70First := true
			for v70Name, v70Value := range in.Financials {
				if v70First {
					v70First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.ProjectSize == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v71First := true
			for v71Name, v71Value := range in.ProjectSize {
				if v71First {
					v71First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.SustainabilityMetrics == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v72First := true
			for v72Name, v72Value := range in.SustainabilityMetrics {
				if v72First {
					v72First = false
				} else {
					out.RawByte(',')
